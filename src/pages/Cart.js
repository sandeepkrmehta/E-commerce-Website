...
const Cart = () => {
  ...
  return (
    <div>
      ...
      <div className="w-full sm:w-10/12 m-auto mt-8">
        {cartProducts.length === 0 ? (
          ...
          <div>
            ...
            {/* Cart Total Section */}
            <div className="p-6 w-full sm:w-2/5 rounded-2xl shadow-2xl bg-white font-bold mt-4 mx-auto">
              ...
              <div className="whitespace-nowrap flex items-center justify-between mt-4">
                ...
                <div className="px-4 py-2 bg-rose-800 rounded-lg text-white cursor-pointer">
